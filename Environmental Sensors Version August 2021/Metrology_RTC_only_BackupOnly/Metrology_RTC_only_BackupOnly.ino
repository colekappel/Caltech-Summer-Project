...
//#define SETTIME // uncomment this line to set the time - note that nothing else will happen except for the time being set if you uncomment this
...
void printHeader(Print &f) {
  ...
  f.write("\n# Time is Local, Temp is *C, Humidity is %, Pressure is hPa or millibar, Accel is m/s^2, Gyro is degrees/s, Mag is gauss\n");
  digitalWrite(8, LOW);
}
